...
public class EditorFrame extends JFrame
{
	...
	/**
	 * Action déclenchée quand on change de mode
	 */
	private final Action chModeAction = new ChModeAction();
...
//		}
	...
	/**
	 * Action pour changer de mode
	 * @author chi
	 */
	private class ChModeAction extends AbstractAction
	{
		/**
		 * Change le mode
		 */
		public ChModeAction()
		{
			...
			putValue(SHORT_DESCRIPTION, "Passe en mode mouvement");
		}
